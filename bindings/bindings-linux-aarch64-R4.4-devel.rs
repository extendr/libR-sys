...
/* bindgen clang version: Ubuntu clang version 14.0.0-1ubuntu1.1 */
/* clang-rs version: Ubuntu clang version 14.0.0-1ubuntu1.1 */
...
pub const R_MONTH: &[u8; 3] = b"08\0";
pub const R_DAY: &[u8; 3] = b"30\0";
pub const R_SVN_REVISION: u32 = 85030;
