...
/* bindgen clang version: Homebrew clang version 22.1.4 */
/* r version: 4.6.0 */
...
pub const R_GE_capability_variableFonts: u32 = 13;
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum R_BindingType_t {
    #[doc = "Unbound in this environment"]
    R_BindingTypeUnbound = 0,
    #[doc = "Direct value binding"]
    R_BindingTypeValue = 1,
    #[doc = "Missing argument"]
...
#[doc = "Dots interface"]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum R_DotType_t {
    R_DotTypeValue = 0,
    R_DotTypeMissing = 1,
    R_DotTypeDelayed = 2,
    R_DotTypeForced = 3,
}
#[doc = "void R_XDREncodeDouble(double d, void *buf);\ndouble R_XDRDecodeDouble(void *buf);\nvoid R_XDREncodeInteger(int i, void *buf);\nint R_XDRDecodeInteger(void *buf);"]
...
extern "C" {
    ...
    #[doc = "int LOGICAL_IS_SORTED(SEXP x);"]
    ...
    pub fn R_envSymbols(env: SEXP) -> SEXP;
    ...
    #[doc = "SEXP Rf_substitute(SEXP,SEXP);"]
    ...
    #[doc = "SEXP Rf_type2rstr(SEXPTYPE);"]
    ...
    pub fn R_GetBindingType(sym: SEXP, env: SEXP) -> R_BindingType_t;
    ...
    pub fn R_MakeDelayedBinding(sym: SEXP, expr: SEXP, evalEnv: SEXP, env: SEXP);
    pub fn R_MakeForcedBinding(sym: SEXP, expr: SEXP, value: SEXP, env: SEXP);
    pub fn R_MakeMissingBinding(sym: SEXP, env: SEXP);
    ...
    pub fn R_ForcedBindingExpression(sym: SEXP, env: SEXP) -> SEXP;
    pub fn R_DelayedBindingExpression(sym: SEXP, env: SEXP) -> SEXP;
    pub fn R_DelayedBindingEnvironment(sym: SEXP, env: SEXP) -> SEXP;
    pub fn R_findDotsEnv(env: SEXP) -> SEXP;
    pub fn R_DotsExist(env: SEXP) -> Rboolean;
    pub fn R_DotsLength(env: SEXP) -> ::std::os::raw::c_int;
    pub fn R_DotsNames(env: SEXP) -> SEXP;
    pub fn R_DotsElt(i: ::std::os::raw::c_int, env: SEXP) -> SEXP;
    pub fn R_GetDotType(i: ::std::os::raw::c_int, env: SEXP) -> R_DotType_t;
    pub fn R_DotDelayedExpression(i: ::std::os::raw::c_int, env: SEXP) -> SEXP;
    pub fn R_DotDelayedEnvironment(i: ::std::os::raw::c_int, env: SEXP) -> SEXP;
    pub fn R_DotForcedExpression(i: ::std::os::raw::c_int, env: SEXP) -> SEXP;
    ...
    #[doc = "Rboolean Rf_conformable(SEXP, SEXP);"]
    ...
    pub fn Rf_isScalarString(arg1: SEXP) -> Rboolean;
    ...
    #[doc = "int\t Rf_stringPositionTr(SEXP, const char *);"]
    ...
    #[doc = "Highly experimental resizable vector support"]
    pub fn R_isResizable(x: SEXP) -> bool;
    pub fn R_maxLength(x: SEXP) -> R_xlen_t;
    pub fn R_resizeVector(x: SEXP, newlen: R_xlen_t);
    pub fn R_allocResizableVector(type_: SEXPTYPE, maxlen: R_xlen_t) -> SEXP;
    pub fn R_duplicateAsResizable(x: SEXP) -> SEXP;
    #[doc = "Attribute support"]
    pub fn R_mapAttrib(
        x: SEXP,
        FUN: ::std::option::Option<
            unsafe extern "C" fn(arg1: SEXP, arg2: SEXP, arg3: *mut ::std::os::raw::c_void) -> SEXP,
        >,
        data: *mut ::std::os::raw::c_void,
    ) -> SEXP;
    pub fn R_getAttributes(x: SEXP) -> SEXP;
    pub fn R_getAttribCount(x: SEXP) -> R_xlen_t;
    pub fn R_getAttribNames(x: SEXP) -> SEXP;
    pub fn R_hasAttrib(x: SEXP, name: SEXP) -> bool;
    pub fn R_nrow(x: SEXP) -> R_xlen_t;
    pub fn R_ncol(x: SEXP) -> R_xlen_t;
    #[doc = "used by BioC::matter; marked as @eapifun for now"]
    ...
    pub fn R_GetSaveAction() -> SA_TYPE;
    pub fn R_SetSaveAction(newval: SA_TYPE) -> SA_TYPE;
    pub fn R_FlushConsole();
    pub fn R_CleanUp(arg1: SA_TYPE, arg2: ::std::os::raw::c_int, arg3: ::std::os::raw::c_int) -> !;
    pub fn R_Busy(arg1: ::std::os::raw::c_int);
    pub fn R_ReadConsole(
        arg1: *const ::std::os::raw::c_char,
        arg2: *mut ::std::os::raw::c_uchar,
        arg3: ::std::os::raw::c_int,
        arg4: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
    pub fn R_WriteConsole(arg1: *const ::std::os::raw::c_char, arg2: ::std::os::raw::c_int);
    pub fn R_WriteConsoleEx(
        arg1: *const ::std::os::raw::c_char,
        arg2: ::std::os::raw::c_int,
        arg3: ::std::os::raw::c_int,
    );
    ...
    pub static mut ptr_CocoaSystem: ::std::option::Option<
    ...
    #[doc = "DATAPTR_RW is declared here since it should only be used to\nimplement Dataptr methods."]
    pub fn DATAPTR_RW(arg1: SEXP) -> *mut ::std::os::raw::c_void;
    ...
    pub fn Rf_eval_with_gd(arg1: SEXP, arg2: SEXP, arg3: pGEDevDesc) -> SEXP;
    ...
    pub fn R_GE_glyphFontNumVar(glyphFont: SEXP) -> ::std::os::raw::c_int;
    pub fn R_GE_glyphFontVarAxis(
        glyphFont: SEXP,
        index: ::std::os::raw::c_int,
    ) -> *const ::std::os::raw::c_char;
    pub fn R_GE_glyphFontVarValue(glyphFont: SEXP, index: ::std::os::raw::c_int) -> f64;
    pub fn R_GE_glyphFontVarFormatted(
        glyphFont: SEXP,
        index: ::std::os::raw::c_int,
    ) -> *const ::std::os::raw::c_char;
    pub fn GEGlyph(
